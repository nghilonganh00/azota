...
const ListQuestionPanel: React.FC<ListQuestionPanelProps> = (props) => {
  ...
  return (
    <div className="relative col-span-6">
      <div className="flex items-center justify-end gap-2 bg-white px-2">
        <div className="flex items-center justify-center gap-1.5 rounded-md border-x border-slate-300 bg-blue-800 px-3 py-1.5 shadow-sm hover:cursor-pointer hover:bg-blue-700">
        ...
        <div className="flex items-center justify-center gap-2 border-x border-slate-300 px-1 py-2.5">
          <CircleAlert strokeWidth={1.6} className="size-4 text-gray-800" />
          <div className="text-[13px] text-gray-900">Thông tin đề</div>
        </div>

        <div className="flex items-center justify-center gap-2">
          <ArrowDownUp strokeWidth={1.6} className="size-5 text-gray-900" />

          <div className="text-[13px] text-gray-900">Đi đến đâu</div>
