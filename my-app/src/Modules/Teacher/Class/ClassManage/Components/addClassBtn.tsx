...
const AddClassBtn: React.FC<AddClassBtnProps> = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    const response: any = await ClassAPI.create(
      className,
      classYear,
      classGroupId,
    );
    ...
    setClassGroupList((preList) => {
      return preList?.map((classGroup) => {
        if (classGroup.id === classGroupId) {
          return {
            ...classGroup,
            Classes: [...classGroup.Classes, { ...data, Classes: [] }],
          };
        }
        return classGroup;
      });
    ...
    console.log("handle submit: ", response.data.data);
          ...
          <div className="space-y-2 px-5 py-2">
            ...
            <div className="rounded-md border border-gray-200">
              ...
              <div className="grid grid-cols-12 px-4 pt-4">
                {classGroupList?.map((classGroup, key) => (
                  <div className="col-span-4" key={key}>
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        onChange={() =>
                          handleChangeValue("classGroupId", classGroup.id)
                        }
