      ...
      <div className="grid grid-cols-12">
        <div className="col-span-5">
          ...
          <div className="mt-1 text-xs/6 text-slate-500">
            Chức năng này giúp giáo viên, người tạo đề có thể đặt giá thu phí
            người tham gia thi, Azota đóng vai trò trung gian cung cấp nền tảng
            và thu hộ, hàng tháng Azota sẽ đối soát và chuyển khoản về tài khoản
            ngân hàng của giáo viên/người tạo đề.
          </div>
          <div className="text-xs text-red-600">
            Lưu ý: Chắc chắn rằng bạn đã đủ 18 tuổi để sử dụng chức năng này
          </div>
