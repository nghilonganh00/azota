...
const ConfigSecurity: React.FC<ConfigSecurityProps> = (props) => {
  ...
  return (
    <div className="rounded-md bg-white px-5 py-6 text-gray-800 shadow">
      <div className="mb-6 border-b border-gray-200 pb-4 text-base font-medium">
        Bảo mật
      </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <input
                  ...
                  value={"ALL"}
                  onChange={(e) =>
                    handleChangeConfig("examTypeAssign", e.target.value)
                  }
        ...
        <div className="grid grid-cols-12">
          <div className="col-span-5">
            ...
            <div className="mt-2 pr-2 text-xs/5 text-slate-500">
              Khi học sinh vào làm bài sẽ phải khai báo thêm các thông tin mà
              bạn yêu cầu.
            </div>
          </div>
